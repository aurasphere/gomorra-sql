...
public class Keywords {
	...
	public final static String[] BEGIN_TRANSACTION_KEYWORDS = { "me", "sient'" };
	public final static String[] COMMIT_KEYWORDS = { "tutt'", "appost" };
	public final static String[] ROLLBACK_KEYWORD = {"sta'", "senza", "pensier"};
